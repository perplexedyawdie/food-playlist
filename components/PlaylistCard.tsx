        ...
        <div className="card rounded-none card-bordered border-4 drop-shadow-[4px_4px_rgba(0,0,0,1)] lg:card-side bg-[#81d0c5] compact">
            ...
            <div className="card-body text-black">
                ...
                <div className="card-actions justify-end">
                    <button className='self-end btn w-16 bg-[#c79ffa] border-black border-4 drop-shadow-[4px_4px] hover:text-[#c79ffa] rounded-none text-black font-bold'>Play</button>
                </div>
            </div>
        </div>
    )
